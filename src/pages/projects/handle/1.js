...
export default () => {
  return (
    <ProjectLayout title="Flex_us '20대를 전시하다'" names="박준수 | 박충실">
      ...
      <Desc fw={400}>
        20대를 이야기하기 위한 전시는 그들만이 가진 특징을 반영한 공간이
        필요했고, ‘새로운 세포’라는 디자인 컨셉을 통해 풀어 나갔다. 또한 전시가
        이루어질 사이트는 기존의 전시공간의 목적으로 사용되는 곳이 아닌 새로움을
        줄 수 있고 다양한 세대가 이용하는 공간을 선정하였다. 사회적인 관계와
        소통을 통해 서로 이해하며 정체성을 찾아가는 청년들의 공간과 시간 그리고
        생각들이 이 프로젝트에 담겨있다.
      </Desc>
      <Zoom>
        <Image src={src1} />
